...
// 4. Parity: all three implementations must agree on every input
// 5. Recursion's stack-depth limit is documented, not silently broken
...
console.log('\n--- Documented limit: C throws RangeError on very large n ---');
let threw = false;
try {
  sum_to_n_c(100000);
} catch (e) {
...
assert(threw, true, 'sum_to_n_c(100000) throws RangeError as documented');
